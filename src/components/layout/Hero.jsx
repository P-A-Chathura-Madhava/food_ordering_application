  ...
  return (
    <section className="mt-4 hero">
      ...
      <div className="flex gap-4 text-sm">
        <button className="flex items-center justify-center gap-2 px-4 py-2 text-white uppercase rounded-full bg-primary">Order Now<Right /></button>
        <button className="flex items-center gap-2 py-2 font-semibold text-gray-600 border-0">Learn More<Right /></button>
      </div>
        </div>
